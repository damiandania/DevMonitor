...
/// The Doctor's "Live Scan": instead of a one-shot log snapshot, it WATCHES Dev Monitor and the
...
final class LiveScan {
    ...
    /// Dev Monitor's internal log every tick (the primary error/bug signal) and takes a few full
    ...
    private func header() -> String {
        ...
        var out = ["=== Dev Monitor live scan — \(duration)s window ==="]
